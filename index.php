...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="index.php" class="logo"><img src="assets/img/apple-icon-180x180.png" alt="" class="img-fluid"> &nbsp <?php echo BANKNAME ?></a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="typeuser.php">&nbsp Login &nbsp</a></li>
        </ul>
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <div class="heroBtn">
            <div><a href="caccounts.php" class="btn-get-started scrollto">Get Started</a></div>
            ...
            <div><a href="typeuser.php" class="btn-get-started scrollto">&nbsp &nbsp &nbsp Login &nbsp &nbsp &nbsp</a></div>
          </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  ...
                  tout est clair l'utilisation du site est facile et m'a facilité de consulter mon compte  lorsque j'ai besoin de voir mon crédit et solde
...
je suis impressioné par le sercive présenté par OM il est rapide et je n'ai plus besoin de sortir pour faire un virement
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="" class="testimonial-img" alt="">
                <h3>Mohamed Yassin</h3>
                <h4>Customer</h4>
              </div>
            </div><!-- End testimonial item -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="transfer.php">Money Transfer</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="Online Banking.html">Online Banking</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="dashboard.php">Check Balance</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="caccounts.php">Create Account</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="login_user.php">Login</a></li>
            </ul>
          </div>

          <div class="col-lg-4 col-md-6 footer-newsletter">
            <div class="d-flex justify-content-center">
              <img src="assets/img/apple-icon-180x180.png" style="width: 100px; height: 100px;" alt="">
            </div>
