		...
		if (isset($_POST['managerLogin']))
		{
		    ...
		    { 
		      ...
		      header('location:mindex.php');
                ...
                header("Location: ../banka/login_manager.php?error=Invalid Credential");
                exit();
            }
		}
                    ...
                    <div class="col-md-7">
                        <div class="card-body">
                            ...
                            <form method="POST">
                                ...
                                <input  name="managerLogin" id="login" class="btn btn-block login-btn mb-4" type="submit" value="Login">
                            </form>
