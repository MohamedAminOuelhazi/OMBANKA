 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item ">  <a class="nav-link active" href="dashboard.php">Home <span class="sr-only">(current)</span></a></li>
...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welecome to OM Bank</h4>
     ...
     ?></p>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-2 rounded-1 shadowBlack" data-ride="carousel" >
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="images/bank2.png" alt="Second slide" style="max-height: 250px">
          </div>
          <div class="carousel-item">
