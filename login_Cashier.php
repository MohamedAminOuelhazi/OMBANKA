...
<?php require 'assets/autoloader.php'; ?>
	...
	<?php
    $con = new mysqli('sql113.epizy.com','epiz_34106075','egak8ETwTdr','epiz_34106075_mybank');
		...
		if (isset($_POST['cashierLogin']))
		{
		    ...
		    { 
		      ...
		      header('location:cindex.php');
                ...
                header("Location: ../banka/login_cashier.php?error=Invalid Credential");
                exit();
            }
		}
                    ...
                    <div class="col-md-7">
                        <div class="card-body">
                            <div class="brand-wrapper">
                                ...
                                <a href="logout.php"><p><?php echo bankname ?></p></a> 
                            </div>
                            ...
                            <form method="POST">
                                ...
                                <input name="cashierLogin" id="login" class="btn btn-block login-btn mb-4" type="submit" value="Login">
                            </form>
